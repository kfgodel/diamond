  ...
  public void define() {
    describe("a behavior call", () -> {
      it("is a method or constructor with arguments defined", () -> {
        TypeMethod method = Diamond.of(MethodCallTestObject.class).methods().named("createdWith").unique().get();
      ...
      it("can be used to invoke same constructor (or static method) with implicit arguments several times", () -> {
        TypeConstructor constructor = Diamond.of(MethodCallTestObject.class).constructors().withNativeParameters(Object.class, Object.class, Object.class).unique().get();
