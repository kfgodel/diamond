package ar.com.kfgodel.diamond.exceptions;
...
import ar.com.kfgodel.diamond.testobjects.exceptions.MemberExceptionsTestObject;
    ...
    public void define() {
        describe("exceptions", () -> {
            ...
            describe("on fields", () -> {
                ...
                context().field(()-> context().typeInstance().fields().existingNamed("field"));
            ...
            describe("on methods", () -> {
                ...
                context().method(() -> context().typeInstance().methods().existingNamed("method"));
