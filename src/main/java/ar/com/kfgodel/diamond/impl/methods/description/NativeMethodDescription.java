...
public class NativeMethodDescription implements MethodDescription {
  ...
  public Supplier<Generics> getGenerics() {
    return CachedValue.from(ExecutableGenericsCalculator.create(nativeMethod));
  }

  @Override
  public Supplier<Unary<Object>> getDefaultValue() {
    return MethodDefaultValueSupplier.create(nativeMethod);
  }

  @Override
  public Supplier<Unary<Method>> getNativeMethod() {
