...
/**
 * This type represents a variable type that can be defined with a concrete type
 * in certain contexts (wildcards and type variables)
...
public class VariableTypeInstance extends TypeInstanceSupport {
  ...
  protected TypeGenerics createGenericsInfoFrom(TypeDescription description) {
    return BoundedTypeGenerics.create(description.getBounds());
  }
}
