...
public interface TypeGenerics extends Generics {
     ...
     *     See genericParameters for the list of type variables that these arguments correspond to
     */
    Stream<TypeInstance> genericArguments();
     ...
     *     See genericArguments for the actual type values of this variables
     */
